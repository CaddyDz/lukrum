          ...
          <div class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-64">
              ...
              <div class="flex flex-col h-0 flex-1">
                <div class="flex items-center h-16 flex-shrink-0 px-4 py-10 bg-gray-900">
                  <!-- <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-logo-indigo-500-mark-white-text.svg" alt="Workflow"> -->
                  <inertia-link :href="route('dashboard')" class="flex">
                      <breeze-application-logo class="flex h-auto w-20" />
                      <div class="flex text-white h-9 w-auto text-xl ml-3 mt-3"><span>SalesForce</span></div>
                  </inertia-link>
                </div>
            ...
            <div class="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
              ...
              <div class="flex-1 px-4 flex justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                  ...
                  <!-- Profile dropdown -->
                  <breeze-dropdown class="ml-3 relative" align="right" width="48">
                      <template #trigger>
                          <span class="inline-flex rounded-md">
                              <button type="button" class="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                ...
                                <img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=A7o4zS7778&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                              </button>
