...
<div class="assets-logo mt-16 ml-12">
    ...
    <nav-steps :step="navStep ? navStep : 5"></nav-steps>
    <div class="mr-6">
        <div class="mb-4">
            <div class="mb-4 ml-2">
...
<!--                <breeze-input id="launchDate" type="date" class="m-1 inline-block w-6/12" placeholder="MM/DD/YY *" />-->
...
<!--
        <div class="asset-example mt-16">
            ...
            <banner-preview
                ...
                :color="$parent.color"
                :headline="$parent.bannerPreview.headline"
...
export default {
    name: "AssetsComments",
    emits: [
        "nextClicked", "backClicked", "commentsUpdated", "launchDateUpdated",
    ],
    props: ["navStep"],
