<template>
  ...
  <div class="h-screen flex overflow-hidden bg-gray-100">
    <notifications style="top: 10px; right: 10px;"/>
    ...
    <div class="flex-1 overflow-auto focus:outline-none" tabindex="0">
      <Header/>
      <main class="flex-1 relative px-10 py-8 z-0 overflow-y-auto">
        <!-- Content -->
        <router-view />
        <!-- End of content -->
      </main>
...
<script>
import Sidebar from '@/InternalAdmin/Components/Sidebar';
import Header from '@/InternalAdmin/Components/Header';
    export default {
      components: {
        Sidebar,
        Header
