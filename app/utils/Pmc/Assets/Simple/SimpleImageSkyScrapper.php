...
class SimpleImageSkyScrapper extends \App\utils\Pmc\Assets\AssetImageAbstract implements \App\utils\Pmc\Assets\Contracts\AssetImageContract
{
    ...
    {
        return "https://res.cloudinary.com/pierry/image/upload/v1619701222/pmc/assets/ke2ckazbub4uyjhazymu.png";
    }

    public function GetEmptyPublicId(): string
    {
        return "pmc/assets/ke2ckazbub4uyjhazymu";
    }
    ...
    public function params()
    {
        return [
            ...
            'headline' => ['l' => 10, 'r' => 10, 'y' => 195, 'c' => "asset", 'sc' => "black", 's' => 0.4166666667, ],
