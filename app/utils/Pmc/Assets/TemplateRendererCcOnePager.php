...
class TemplateRendererCcOnePager extends TemplateRendererAbstract implements Contracts\TemplateRendererContract
{
    ...
    public function Render(TemplateContract $template, PmcForm $pmc): string
    {
        ...
        $headline = $cc->op_headline_edited ? $cc->op_headline_edited : $cc->op_headline_original;
        $intro = $cc->op_subhead_edited ? $cc->op_subhead_edited : $cc->op_subhead_original;
        $body = $cc->op_body_edited ? $cc->op_body_edited : $cc->op_body_original;
        $cta = $cc->op_cta_edited ? $cc->op_cta_edited : $cc->op_cta_original;
        ...
        $output = str_replace('[[:professionals:]]', $cc->op_professionals, $output);
        $output = str_replace('[[:projects:]]', $cc->op_projects, $output);
